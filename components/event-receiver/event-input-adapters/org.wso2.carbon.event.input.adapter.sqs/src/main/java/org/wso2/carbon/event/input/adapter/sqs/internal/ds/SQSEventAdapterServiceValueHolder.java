 ...
 */
public final class SQSEventAdapterServiceValueHolder {

    private static RealmService realmService;
    private static HttpService httpService;

    private SQSEventAdapterServiceValueHolder() {
    }

    public static void registerRealmService(
            RealmService realmService) {
        SQSEventAdapterServiceValueHolder.realmService = realmService;
    }
